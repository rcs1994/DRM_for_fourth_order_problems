...
if os.path.exists('Codes_2D/P3/DRM/results/y.pt'):
    y = torch.load('Codes_2D/P3/DRM/results/y.pt', weights_only=False)
else:
...
def closure_adam():
    ...
    for i, subquad in enumerate(loader):
        ...
        loss, loss_int, loss_neumann, loss_diri = pde.pdeloss(
...
# Save errors to CSV
csv_path = 'Codes_2D/P3/DRM/results/errors.csv'
